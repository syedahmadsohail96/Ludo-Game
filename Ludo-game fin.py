...
canvas = Canvas(width = 1000, height = 703, bg = 'gray')
...
class RollTheDice:
    def __init__(self, parent):
        ...
        self.dieLabel = Label(self.dieContainer, text="Number of Dice you will be rolling:", fg="black")
        self.dieLabel.place(x=730,y=30)

        self.dieEntry = Entry(self.dieContainer)
        self.dieEntry.place(x=730,y=60)

        self.sideLabel = Label(self.dieContainer, text="Number of Sides per Die:")
        self.sideLabel.place(x=730,y=130)

        self.sideEntry = Entry(self.dieContainer)
        self.sideEntry.place(x=730,y=160)
        ...
        self.quitButton.place(x=880,y=200)
